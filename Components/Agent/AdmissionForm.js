...
import { API_COURSE,API_GETRELIGION,API_GETCOMMUNITIES,API_GETBOARDS,API_GETBOARDSUBJECT,API_CREATEAGENT } from '../../APILIST/APILIST';
...
export function AdmissionForm({route,navigation}) {
  ...
  const [chosenDateFrom, setChosenDateFrom] = useState(new Date());
    ...
    const toggleSelectedIndex = (value) =>{
      if(value == 1)
      {
        selectedIndex(1)
  ...
  useEffect(() => {
    ...
    const onHandleSubmit = async () =>{      
      ...
      inputValues['department_id'] = 10
      inputValues['dob'] = chosenDateFrom
      inputValues['government_quota'] = "0"
      inputValues['government_scheme'] = "test"
      inputValues['religion_id'] = "28"
      inputValues['community_id'] = "5"
      inputValues['hsc_all_mark'] = "{maths:100,chemistry:100,physics:100}"
        ...
        <View style={{flex:1,backgroundColor:'#F7F8FA',paddingBottom:20}}>
            ...
            >
                <View style={styles.modelViewHsc}>  
                  ...
                  {
                    loading?(
                      <TouchableOpacity style={[styles.loginBtn,{width:'50%',backgroundColor:'#FCB301'}]}>
            ...
            <TouchableOpacity style={[styles.loginBtn,{marginTop:20,flexDirection:'row',justifyContent:'space-around',padding:10}]} >
                <View style={styles.circleCss}>
                  <IconION name="call-outline" size={20}/> 
                </View>
                <View>
                  <Text style={styles.loginText} >
                    Request a Call Back
